...
export default defineConfig({
  define: {
    API_URL: 'http://meeting-test.xinzhisc.com', // API地址
    ...
    UPLOAD_IMG:
      '/adminV1/api/adm/fs/uploadByForm?filePath=/images/partyBuilding/&module=operatingPlatform', //图片上传

    UPLOAD_FILES: '/adminV1/api/adm/fs/uploadByForm?filePath=/file/&module=operatingPlatform', //文件上传
