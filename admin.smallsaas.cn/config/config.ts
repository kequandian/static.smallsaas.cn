...
export default defineConfig({
  ...
  define: {
    AKSAPI: 'http://202.63.172.43:5800',

    REACT_APP_ENV: REACT_APP_ENV || false,
    // LAUNCHER_API_URL: 'http://202.63.172.178:8000/pb', // LAUNCHER API地址
    LAUNCHER_API_URL: '/pb', // LAUNCHER API地址
    ...
    roomUrlDve: 'http://192.168.3.22:3000', //本地
    roomUrlPro: 'http://202.63.172.178:5002', //线上node
    launcherUpload: 'http://spbs.gzbocdn.com:8000/portal/file/upload', //launcher http://spbs.gzbocdn.com:8000/portal/file/upload
  },
  extraPostCSSPlugins: [
  ...
  requestRecord: {},
  // publicPath: '/admin/', // 添加这行，所有静态资源都会加上 /admin/ 前缀
  // base: '/admin/', // 如果有路由问题也加上这个
});
