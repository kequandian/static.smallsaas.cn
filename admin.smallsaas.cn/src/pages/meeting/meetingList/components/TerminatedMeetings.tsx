import { getTerminatedMeetingList, cancelMeeting } from '@/api/meeting';
...
const TerminatedMeetings: React.FC = () => {
  ...
  const request = async (params: any) => {
    const { data } = await getTerminatedMeetingList({
...
export default TerminatedMeetings;
