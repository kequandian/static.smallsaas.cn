    ...
    return React.Children.map(children, child => {
        ...
        return (
            <div style={{ backgroundColor: 'transparent' }}>
                <div style={{ marginBottom: '', backgroundColor: 'transparent',position: "absolute",left:'0%',  zIndex:20,margin:'8px' }}>
                ...
                <div style={{width:'100%',height:'100%', backgroundColor: 'transparent', position: "absolute",left:'0%', zIndex: 10 }}>
                    {child}
                </div>
            </div>
        )
