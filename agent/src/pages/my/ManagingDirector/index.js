            ...
            {data ? (
                ...
                <CssCart backgroundColor='' >
                    <CssCart padding='20px 20px 0 20px '
                        //  backgroundColor='#78d2c1'
                        background='linear-gradient(141deg, rgba(88, 85, 232)1%,rgba(62, 196, 160)80%)'
                        height='120px'>
                        <AvatarCard title={data.name} subtitle={data.status} avatar='http://static.smallsaas.cn/house/2022/svg/Router/invite.svg' navigation={`/my/ModifyAvatar?title=${data.name}&icon=${data.avatar}`}>
