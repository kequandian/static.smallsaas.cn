    ...
    return (
        ...
        {data && Array.isArray(data) && data.length > 0 ? (
            ...
            <CssCart backgroundColor=''>
                <CssCart padding='20px 20px 0 20px ' backgroundColor='#8dd7cf' height='150px'>
                    <AvatarCard title={data[0].name} subtitle={data[0].status} avatar='http://static.smallsaas.cn/house/2022/svg/Router/invite.svg' >
                ...
                <CssCart backgroundColor='' padding='0 20px ' width='100%'>
                       <Head list={data} />
                </CssCart>

                <Router items={[
                    { "icon": "http://static.smallsaas.cn/house/2022/svg/Router/invite.svg", "title": "我的邀请", "nextIcon": "http://static.smallsaas.cn/house/2022/svg/Router/enter.svg", "navigation": "/my/MyInvite" },
                    { "icon": "http://static.smallsaas.cn/house/2022/svg/Router/ThreeLevelAgent.svg", "title": "三级代理", "nextIcon": "http://static.smallsaas.cn/house/2022/svg/Router/enter.svg", "navigation": "/my/MyTeam" },
                    { "icon": "http://static.smallsaas.cn/house/2022/svg/Router/history.svg", "title": "二级代理", "nextIcon": "http://static.smallsaas.cn/house/2022/svg/Router/enter.svg", "navigation": "/my/proxyDetails" },
                    {},
                    { "icon": "http://static.smallsaas.cn/house/2022/svg/Router/report.svg", "title": "结算报表", "nextIcon": "http://static.smallsaas.cn/house/2022/svg/Router/enter.svg", "navigation": "/my/SettlementStatements" },
                    ...
                    { "icon": "http://static.smallsaas.cn/house/2022/svg/Router/SetUp.svg", "title": "设置", "nextIcon": "http://static.smallsaas.cn/house/2022/svg/Router/enter.svg", "navigation": "/my/Set/GeneralAgentSet" },
                ]} />
