...
export default function index(props) {
  ...
  return (
    <ChakraProvider>
      ...
      <div style={{ position: 'relative', width: '100%', margin: '0 10px 0 0' }}>
        <Stack w='100%' spacing='0' borderRadius='0 0 4px 4px' >
          <Box w='' border='0px solid #f5f5f5' backgroundColor='#ffffff' boxShadow='0 0 4px rgba(0, 0, 0, 0.12)' padding='0' fontSize='18px' onClick={() => onProvince()}  >
            {Selectprovince && !SelectCity && !SelectRegion ?
              <Box color='#aebac9' h='40px' w='100%'  borderRadius='10px 0 0 10px'   lineHeight='37px' border='0px solid #ecf0f5' fontSize='18px' onClick={() => onProvince()}>
                <Input value={Selectprovince} minLength='4' placeholder='we' onBlur={() => onBlurStatus()} onFocus={() => onFocusStatus()} />
              </Box>
              :
              SelectCity && !SelectRegion ?
                <Box color='#aebac9' h='40px' w='100%'  lineHeight='37px' border='0px solid #ecf0f5' fontSize='18px' onClick={() => onProvince()}>
                ...
                SelectRegion ?
                  ...
                  :
                  <Box color='#aebac9' h='40px' w='100%' padding=' 0 0 0 10px' lineHeight='37px' border='0px solid #ecf0f5' fontSize='18px' onClick={() => onProvince()}>
                    {/* <Box > */}
                    {/* <Center w='90px'> */}
                    请选择
                    {/* </Center> */}
          ...
          {ClickStatus ?
            // <div style={{ position: 'absolute', top: '40px', left: '10px', height: '200px', backgroundColor: '#ffffff', zIndex: 9999999 }}>
            <div style={{ position: 'absolute', top: '40px', left: '-40px', height: '200px', backgroundColor: '#ffffff', zIndex: 9999999 }}>
              <Box h='100%'>
                <Flex h='100%'>
