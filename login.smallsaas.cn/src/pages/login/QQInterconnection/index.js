...
export default function index(props) {
    ...
    function validateData() {
        ...
        w.location.href = `https://graph.qq.com/oauth2.0/authorize?client_id=101995206&response_type=code&redirect_uri=https://www.smallsaas.cn/login/qq`;
    }

    return (
        <>
            <Center padding='20px' h='500px'>
                <Center w='440px' padding='90px 60px ' onClick={() => validateData()}  boxShadow='0 0px 8px rgba(0, 0, 0, 0.08) '>
                        <Stack backgroundColor='#6bb0df'borderRadius='8px' padding=' 30px 26px 24px' >
                            <Center h='12px' margin='0 2px' w=''>
