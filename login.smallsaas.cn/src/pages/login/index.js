...
export default function index(props) {
    ...
    return (
        <ChakraProvider>
            <div className='login' />
            <Stack spacing={6} w='100%' padding='10px'>
                <>
                    <Flex position='' top='' padding=' ' margin='' w='100%' h='180px' left='10%'>
                         ...
                         */}
                        <Center h='100%'>
                            <div style={{ height: '60px', width: "60px", backgroundSize: '100%', backgroundImage: 'url(https://static.smallsaas.cn/house/2022/image/SmallSaaS/SmallSaaS.png)' }} />
                        </Center>
                        ...
                        <Center h='100%' margin='0 0 0 16px '>
                            <Stack h='100%' spacing={0}>
                                <svg
                                    ...
                                    <text font-family="SimHei" fill="rgb(255, 255, 255)" font-size='40px' x="0px" y="88.047px">&#22823;&#24179;&#21488;&#32;&#23567;&#24212;&#29992;</text>
                                </svg>
