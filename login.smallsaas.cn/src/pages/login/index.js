...
export default function index(props) {
    ...
    return (
        <ChakraProvider>
            ...
            <Center position='fixed' top='70px' padding='0 0 0 ' margin='auto' w='100%'>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="669px" height="98px">
                    <text font-family="SimHei" fill="rgb(255, 255, 255)" font-size="102px" x="0px" y="88.047px">&#22823;&#24179;&#21488;&#32;&#23567;&#24212;&#29992;</text>
                </svg>

            </Center>
            <Center position='fixed' top='160px' padding='0 0 0 ' margin='auto' w='100%'>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="669px" height="88px">
                    <text font-family="FangSong" fill="rgb(255, 255, 255)" font-size="32px" x="0px" y="88px"> <tspan dy="-10.063px">&#26080;&#20195;&#30721;&#33258;&#30001;&#21019;&#24314;&#23567;&#24212;&#29992;&#65307;&#24212;&#29992;&#21363;&#33402;&#26415;&#65292;&#29992;&#23436;&#21363;&#24323;</tspan><tspan x="0px" dy="1.2em"> </tspan>
                    </text>
                </svg>
            </Center>
            <Center position='fixed' top='66px' left='220px' zIndex='-1' h='180px' w="180px" backgroundSize='100%' backgroundImage='url(https://static.smallsaas.cn/house/2022/image/SmallSaaS/SmallSaaS.png)'>

            </Center>

            <Center position='fixed' width='100%' height='100%' padding='16px ' margin='100px 0' >
                <Stack spacing={6} w='400px'>
                    <>
                        <form noValidate>
                            <Spacer />
                            <Stack spacing={6} h='' padding='6px'>
                                <>
                                    <InputGroup size='md' errorBorderColor>
                                        <InputLeftAddon
                                            children={<Number />}
                                        />
                                        <Input type='tel' variant='solid' value={phone} placeholder='号码' onChange={(e) => changePhone(e)} />
                    ...
                    <Box padding='0 0px' onClick={() => validateData()}>
                    ...
                    < Center>
                        <a href='https://connect.qq.com/manage' target="_blank"  >
